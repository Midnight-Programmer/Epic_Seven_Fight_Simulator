...
public class EpicSevenController {
  ...
  @FXML private ChoiceBox<String> hero1_dropdown;
  @FXML private ChoiceBox<String> hero2_dropdown;
  @FXML private ChoiceBox<String> hero3_dropdown;
  @FXML private ChoiceBox<String> hero4_dropdown;
  @FXML private Button button1;

  @FXML private TextField hero1_attack;
  ...
  @FXML
  private void hero1DropdownSelected(ActionEvent event) {
    String name = hero1_dropdown.getValue();
  }
}
